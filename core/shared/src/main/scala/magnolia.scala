...
object Magnolia {
  ...
  def subtype[Tc[_], T, S <: T](name: TypeName,
    ...
    new Subtype[Tc, T] with PartialFunction[T, S] {
      ...
      def annotationsArray: Array[StaticAnnotation] = anns
  ...
  def param[Tc[_], T, P](name: String,
                         ...
                         defaultVal: => Option[P],
                         deref: T => P,
                         annotationsArrayParam: Array[StaticAnnotation]
    ...
    def annotationsArray: Array[StaticAnnotation] = annotationsArrayParam
  }
  ...
  def caseClass[Tc[_], T](name: TypeName,
                          ...
                          annotations: Array[StaticAnnotation],
